...
export const MINDAR_CONFIG = {
  ...
  filterMinCF: 0.001,  // original working value
  filterBeta: 10,      // original working value — smooth stable lock-on
  warmupTolerance: 2,  // original working value
  missTolerance: 3,    // stable tracking
};
