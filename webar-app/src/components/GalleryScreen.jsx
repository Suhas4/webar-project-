...
const styles = {
  ...
  backBtn: { background:"transparent",border:"none",color:"rgba(255,255,255,0.7)",
  ...
  empty: { flex:1,display:"flex",alignItems:"center",justifyContent:"center",
    color:"rgba(255,255,255,0.5)",fontSize:16,fontFamily:FONT,padding:40 },
  grid: { padding:"0 16px 40px",display:"flex",flexDirection:"column",gap:12 },
  card: { background:"rgba(255,255,255,0.1)",borderRadius:16,overflow:"hidden",
    display:"flex",alignItems:"center",gap:12,padding:12 },
  thumb: { width:80,height:80,objectFit:"cover",borderRadius:10,flexShrink:0 },
  thumbPlaceholder: { width:80,height:80,background:"rgba(255,255,255,0.1)",
  ...
  playBtn: { background:"rgba(0,201,167,0.2)",border:"1px solid rgba(0,201,167,0.5)",
    borderRadius:8,color:"#00C9A7",fontSize:12,fontFamily:FONT,padding:"5px 14px",cursor:"pointer" },
  deleteBtn: { background:"rgba(255,80,80,0.15)",border:"1px solid rgba(255,80,80,0.4)",
